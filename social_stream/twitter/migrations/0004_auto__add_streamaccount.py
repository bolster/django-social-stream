...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StreamAccount'
        db.create_table(u'twitter_streamaccount', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from='name')),
            ('oauth_token', self.gf('django.db.models.fields.CharField')(max_length=1000)),
            ('oauth_token_secret', self.gf('django.db.models.fields.CharField')(max_length=1000)),
        ))
        db.send_create_signal(u'twitter', ['StreamAccount'])


    def backwards(self, orm):
        # Deleting model 'StreamAccount'
        db.delete_table(u'twitter_streamaccount')
