...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Tweet.possibly_sensitive'
        db.delete_column(u'twitter_tweet', 'possibly_sensitive')


    def backwards(self, orm):
        # Adding field 'Tweet.possibly_sensitive'
        db.add_column(u'twitter_tweet', 'possibly_sensitive',
