...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stream._restart'
        db.add_column(u'twitter_stream', '_restart',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stream._restart'
        db.delete_column(u'twitter_stream', '_restart')
    ...
    models = {
        ...
        u'twitter.stream': {
            ...
            '_restart': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
