...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TrackedTerm.required'
        db.add_column(u'twitter_trackedterm', 'required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FollowedLocation.required'
        db.add_column(u'twitter_followedlocation', 'required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'FollowedUser.required'
        db.add_column(u'twitter_followeduser', 'required',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TrackedTerm.required'
        db.delete_column(u'twitter_trackedterm', 'required')

        # Deleting field 'FollowedLocation.required'
        db.delete_column(u'twitter_followedlocation', 'required')

        # Deleting field 'FollowedUser.required'
        db.delete_column(u'twitter_followeduser', 'required')
