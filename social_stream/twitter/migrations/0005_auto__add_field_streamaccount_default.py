...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StreamAccount.default'
        db.add_column(u'twitter_streamaccount', 'default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StreamAccount.default'
        db.delete_column(u'twitter_streamaccount', 'default')
