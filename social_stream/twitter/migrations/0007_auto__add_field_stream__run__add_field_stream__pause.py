...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stream._run'
        db.add_column(u'twitter_stream', '_run',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Stream._pause'
        db.add_column(u'twitter_stream', '_pause',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stream._run'
        db.delete_column(u'twitter_stream', '_run')

        # Deleting field 'Stream._pause'
        db.delete_column(u'twitter_stream', '_pause')
